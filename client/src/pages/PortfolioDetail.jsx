...
const project = {
  ...
  content: `
    <p>East Legon Skyline Villas is our flagship residential development, set in one of Accra's most prestigious neighbourhoods. The community combines contemporary architecture with serene landscaped grounds to create a truly elevated living experience.</p>
    ...
    <h2>Location</h2>
    <p>Located within minutes of top international schools, shopping centres and hospitals, the villas offer both convenience and tranquillity.</p>
  `,
          ...
          <div className="post-content">
            ...
            <aside className="post-sidebar">
              ...
              <div className="sidebar-widget">
                ...
                <a className="contact-cta" href="tel:+233241234567"><FaPhoneAlt /> +233 24 123 4567</a>
